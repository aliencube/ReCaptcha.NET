...
{
    public static Aliencube.ReCaptcha.Wrapper.WebApp.Controllers.HomeController Home = new Aliencube.ReCaptcha.Wrapper.WebApp.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string jquery_2_1_3_vsdoc_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-2.1.3-vsdoc.min.js") ? Url("jquery-2.1.3-vsdoc.min.js") : Url("jquery-2.1.3-vsdoc.js");
